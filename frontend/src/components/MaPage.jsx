...
const MaPage = ({ onNavigate }) => {
        ...
        return (
            <div className="page-container">
                ...
                <div className="empty-state">
                    ...
                    <button className="submit-project-btn" onClick={onNavigate}>
                        Deposer un projet
                    </button>
                </div>
            </div>
    ...
    // On vérifie s'il y a vraiment une image (pas une chaine vide ni un dossier vide)
    const currentImage =
        currentProject.img &&
                ...
                <div className="image-card">
                    {currentImage ? (
                        <img
                            ...
                            onError={(e) => {
                                e.target.onerror = null; // Prévient la boucle infinie
